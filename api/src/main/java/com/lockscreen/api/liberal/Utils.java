package com.lockscreen.api.liberal;
...
import com.lockscreen.api.BuildConfig;
...
public class Utils {
    ...
    public static void addAlertAttribute(Window window) {
        window.setType(Build.VERSION.SDK_INT >= 19?2005:2003);
    }
