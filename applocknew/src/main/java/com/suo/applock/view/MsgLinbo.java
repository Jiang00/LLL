...
public class MsgLinbo {
    ...
    public static class Data {
        ...
        public int icon = R.drawable.suo_ic;
    ...
    public abstract static class OnLongClickListener2<T extends View> implements View.OnLongClickListener {
        public T dialog;
    }
