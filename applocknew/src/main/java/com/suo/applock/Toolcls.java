...
//        Toolcls.runActionWithRoot("pm disable-user " + pkg);
        return Toolcls.runActionWithRoot("pm enable " + pkg);
    }

    public static boolean hideApp(String pkg) {

        return Toolcls.runActionWithRoot("pm disable " + pkg);
    }
...
//            dos.writeBytes("su");
    ...
    public static void RandomNumpad(MyAppBridge bridge, View root, String[] buttons) {
