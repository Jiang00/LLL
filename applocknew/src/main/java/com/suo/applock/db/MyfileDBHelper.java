 ...
 */
public class MyfileDBHelper extends SQLiteOpenHelper {
    public static final int VERSION = 1;
    public static final String NAME = "_PROFILES_";
    private static MyfileDBHelper helper;

    public static synchronized MyfileDBHelper singleton(Context context){
        if (helper == null){
            helper = new MyfileDBHelper(context.getApplicationContext(), NAME, null, VERSION);
            helper.getWritableDatabase();
        }
        return helper;
    }

    public MyfileDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    public MyfileDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
    ...
    public static class ProfileEntry implements Baseline {
        public long id;
        public String name;
