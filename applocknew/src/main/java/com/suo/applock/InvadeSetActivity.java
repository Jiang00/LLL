...
//        标题
    ...
    public static class SettingFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            intruder.setChecked(SharPre.fetchIntruder());//com.lockscreen.lock.Preference.isFetchIntruderEnabled()
            ...
            int slot = com.suo.applock.Preference.getIntruderSlot();
            ...
            shutter.setChecked(com.suo.applock.Preference.isShutterSoundEnabled());
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            switch (preference.getKey()) {
                case SETTING_CATCH_INTRUDER_SLOT: {
                    ...
                    lp.setValue(value);
                    com.suo.applock.Preference.setIntruderSlot(slot);
                    Log.i("aaaaaa","--------------"+slot);
...
//                    com.lockscreen.lock.Preference.setCatchIntruderEnable(yes);
                ...
                case SETTING_INTRUDER_SHUTTER: {
                    boolean yes = (boolean) newValue;
                    com.suo.applock.Preference.setShutterSoundEnabled(yes);
                }
                break;
            }
            return true;
