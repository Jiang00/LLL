package com.suo.applock.yibuasync;
...
import com.suo.applock.BuildConfig;
 ...
 */
public class ImageTManager {
    public static final String ROOT = Environment.getExternalStorageDirectory() + BuildConfig.SUO_DIR_E;
                ...
                if (local){
                    if (cache.get(url) == null){
                        ...
                        try{
                            ...
                            e.printStackTrace();
//                            TCAgent.onError(v.getContext(), e);
                        }
                    }
                }
            }
